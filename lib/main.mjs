...
function canonicalCycleTheme(theme) {
  ...
  // light and dark leave pages plain, so they sit where Clear sits.
...
class PdfPreviewApp {
  ...
  updateThemeToggle() {
    ...
    const description = enabled
      ? `Switch PDF page mode to ${nextLabel} — Shift+click or right-click for plain white pages`
